...
echo "viennacl::ocl::program & RegisterMyCommonKernels(viennacl::ocl::context *ctx);" >> $HEADER
echo "template <typename Dtype>" >> $HEADER
echo "viennacl::ocl::program & RegisterMyKernels(viennacl::ocl::context *ctx);" >> $HEADER
echo "template <typename Dtype>" >> $HEADER
echo "std::string getMyKernelBundleName(int index);" >> $HEADER
echo "int getMyKernelBundleCount();" >> $HEADER
echo "template<typename Dtype>" >> $HEADER
echo "std::string getMyKernelBundleSource(int index);" >> $HEADER
echo "}  // namespace caffe" >> $HEADER
echo "#endif" >> $HEADER
...
echo "viennacl::ocl::program & RegisterMyCommonKernels(viennacl::ocl::context *ctx) {" >> $SOURCE
...
echo "viennacl::ocl::program & RegisterMyKernels(viennacl::ocl::context *ctx) {" >> $SOURCE
echo "  std::stringstream ss;" >> $SOURCE
...
echo "viennacl::ocl::program & RegisterMyKernels<half>(viennacl::ocl::context *ctx);" >> $SOURCE
echo "#endif" >> $SOURCE
echo "template" >> $SOURCE
echo "viennacl::ocl::program & RegisterMyKernels<float>(viennacl::ocl::context *ctx);" >> $SOURCE
echo "template" >> $SOURCE
echo "viennacl::ocl::program & RegisterMyKernels<double>(viennacl::ocl::context *ctx);" >> $SOURCE
echo "int getMyKernelBundleCount() {" >> $SOURCE
echo "  return cl_kernels.size();" >> $SOURCE
echo "}" >> $SOURCE
echo "template<typename Dtype>" >> $SOURCE
echo "std::string getMyKernelBundleSource(int index) {" >> $SOURCE
echo "  std::stringstream ss;" >> $SOURCE
echo "#ifdef USE_INDEX_64" >> $SOURCE
echo "  ss << header << \"\n\n\";  // NOLINT" >> $SOURCE
...
echo "}" >> $SOURCE
echo "template std::string getMyKernelBundleSource<half>(int index);" >> $SOURCE
echo "template std::string getMyKernelBundleSource<float>(int index);" >> $SOURCE
echo "template std::string getMyKernelBundleSource<double>(int index);" >> $SOURCE
echo "std::string getMyKernelBundleName(int index) {" >> $SOURCE
